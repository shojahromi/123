...
> در این پروژه از شبکه عصبی LSTM استفاده خواهیم
کرد. به طور خلاصه، LSTM یک نوع خاص از یک شبکه عصبی RNN است که در پردازش داده هایی که دارای توالی منظم و مرتبط هستند استفاده میشود. مثل متون، موسیقی ها، ویدئو ها و...
...
2.         layers.LSTM(128),
2.         layers.Dense(len(chars), activation=&quotsoftmax&quot),
3.     ]
4. )
4. optimizer = optimizers.Adam(learning_rate=0.01)
5. model.compile(loss=&quotcategorical_crossentropy&quot, optimizer=optimizer)
...
![Alt text](https://files.virgool.io/upload/users/1223901/posts/rynq4emx1qcx/plrkjthnkq7a.png)
